VERSIONS = {
    ...
    # SHA256 hashes for the upstream LLVM prebuilt release tarballs used by
    # //compiler/cross to extract cross-compilation static libs.
    # Values sourced from bazel-contrib/toolchains_llvm llvm_distributions.bzl.
    "llvm_prebuilt_sha256": {
        "aarch64-linux-gnu": "dcaa1bebbfbb86953fdfbdc7f938800229f75ad26c5c9375ef242edad737d999",
        "x86_64-linux-gnu-ubuntu-18.04": "54ec30358afcc9fb8aa74307db3046f5187f9fb89fb37064cdde906e062ebf36",
    },

    # SHA256 hashes for published cross-compilation lib tarballs, keyed by arch.
    # Updated after the tarballs are built and published to GitHub releases
    # via //compiler/cross:cxx_cross_{arch}.
    "libcxx_cross_sha256": {
        "aarch64": "",
        "x86_64": "",
    },
