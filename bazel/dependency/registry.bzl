...
#
# TEST_SRCDIR is checked before RUNFILES_DIR: Bazel guarantees it is the
# runfiles root under `bazel test`, whereas RUNFILES_DIR may have been
# repointed by a calling test script.
