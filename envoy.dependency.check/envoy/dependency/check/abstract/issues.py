...
class AGithubDependencyIssues(metaclass=abstracts.Abstraction):
    ...
    async def create(
            self,
            dep: "abstract.AGithubDependency") -> AGithubDependencyIssue:
    ...
    async def issue_body(self, dep: "abstract.AGithubDependency") -> str:
    ...
    async def issue_title(self, dep: "abstract.AGithubDependency") -> str:
